...
public class MainPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        electronicsButton.setFont(new java.awt.Font("Roboto", 0, 18)); // NOI18N
        electronicsButton.setForeground(new java.awt.Color(255, 255, 255));
        electronicsButton.setText("Home & Essentials");
        ...
        mobilesButton.setFont(new java.awt.Font("Roboto", 0, 18)); // NOI18N
        mobilesButton.setForeground(new java.awt.Color(255, 255, 255));
        mobilesButton.setText("Cloths & Fabrics");
        ...
        kidsButton.setText("Accessories");
        ...
        jPanel8Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                .addGap(499, 499, 499)
                .addComponent(billLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(39, 39, 39)
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        if(searchBar.getText().equals(""))
            ...
            for(j=k; j<Search.mobile+Search.electronics+Search.kids; j++){
                ...
                ImageIcon ii = new ImageIcon(getClass().getResource("/products/kids/"+temp));
                Image resizedImage = ii.getImage();
                ii = new ImageIcon(resizedImage.getScaledInstance(260, 360, Image.SCALE_SMOOTH));
