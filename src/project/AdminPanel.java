...
public class AdminPanel extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        mCat.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Home & Essentials", "Clothing & Fabrics", "Accessories" }));
        ...
        stockStatusCat.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Home & Essentials", "Clothing & Fabrics", "Accessories" }));
        ...
        delUpdateCat.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Home & Essentials", "Clothing & Fabrics", "Accessories" }));
    ...
    private void updateStockButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateStockButtonActionPerformed
       ...
       try{
            ...
            if(stockStatusCat.getSelectedItem().equals("Home & Essentials")){
                ElectronicsDB.flag = true;
                ElectronicsDB.updateElectronicsDB(model, qty);
            }

            else if(stockStatusCat.getSelectedItem().equals("Clothing & Fabrics")){
                MobileDB.flag = true;
    ...
    private void delEntryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delEntryActionPerformed
        ...
        if(delUpdateCat.getSelectedItem().equals("Home & Essentials")){
            ElectronicsDB.delete(del);
        }
        else if(delUpdateCat.getSelectedItem().equals("Clothing & Fabrics")){
            MobileDB.delete(del);
        }
